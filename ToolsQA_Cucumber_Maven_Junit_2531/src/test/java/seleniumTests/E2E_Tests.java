...
public class E2E_Tests 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		WebElement stateDropDown = driver.findElement(By.cssSelector("#billing_state_field .select2-arrow"));
		stateDropDown.click();
		Thread.sleep(2000);
		
		List<WebElement> stateList = driver.findElements(By.cssSelector("#select2-drop ul li"));
